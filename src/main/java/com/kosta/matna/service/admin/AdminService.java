...
public interface AdminService {
	...
	//public List<Member_orderVO> orderlistAll( RowBounds rowBounds)throws Exception;//전체주문 조회selectAll
	...
	public int orderListCount(Map<String, String> map)throws Exception;//전체 주문 갯수 select
	...
	public List<Member_orderVO> orderMyList(int ono, RowBounds rowBounds)throws Exception;//마이페이지 주문리스트 조회selectAll
