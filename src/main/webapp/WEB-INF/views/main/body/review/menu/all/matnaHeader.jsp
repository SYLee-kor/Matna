  	...
  	<div class="container">
    	<div class="row">
        	<div class="col-md-4 col-sm-4">
            	<div class="templatemo_title"><a href="#">Matna</a></div>
				...
				<div class="row">
                     <div class="col-md-12 navigation">
						<div class="row main_menu">
							...
							<div class="col-md-2"><a class="show-2 templatemo_page2" href="#"><div class="fa fa-cutlery"></div></a></div>
				...
				<div class="flexslider">
					<ul class="slides">
						<li>
							...
							<img src="../../../images/AD_chicken.jpg" alt="Slide 1">
						</li>

						<li>
							<div class="slider-caption"></div>
							<img src="../../../images/AD_bugerking.jpg" alt="Slide 2">
						</li>

                        <li>
							<div class="slider-caption"></div>
							<img src="../../../images/AD_pizza.jpg" alt="Slide 3">
						</li>
