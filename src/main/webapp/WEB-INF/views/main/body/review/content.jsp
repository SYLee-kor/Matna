...
<!-- services 라이브러리 불러오기 -->
<link rel="stylesheet"
	href="/matna/resource/jqplot/jquery.jqplot.min.css">
<script type="text/javascript"
	src="//apis.daum.net/maps/maps3.js?apikey=d57f90536554e1d1025bdf0836b0ed4f&libraries=services"></script>
...
<script type="text/javascript"
	src="/matna/resource/jqplot/plugins/jqplot.pieRenderer.min.js"></script>
<script type="text/javascript">
...
<body>
	...
	<form name="reviewForm" id="reviewForm" class="reviewF">
				...
				<tr>
					<td>
						<p id='one' style="margin-left: 50px">
							<label class="fa fa-user fa-2x"></label> <label
								class="preview_la">&nbsp;&nbsp;&nbsp; 작성자:</label> &nbsp;&nbsp;<b>${review.nickName }</b></br>
							<label class="fa fa-hand-o-up fa-2x"></label> <label
								class="preview_la">&nbsp;&nbsp;&nbsp; 조회수:</label> &nbsp;&nbsp;<b>${review.viewCnt }</b></br>
							<label class="fa fa-truck fa-2x"></label> <label
								class="preview_la">&nbsp; 주차장여부:</label> &nbsp;&nbsp;<b>${parking}</b></br>
							<label class="fa fa-money fa-2x"></label> <label
								class="preview_la">&nbsp; 1인비용:</label> &nbsp;&nbsp;<b>${preview.price }</b></br>
							<label class="fa fa-cutlery fa-2x"></label> <label
								class="preview_la">&nbsp;&nbsp;&nbsp; 추천메뉴:</label> &nbsp;&nbsp;<b>${preview.recommend }</b></br>
							<label class="fa fa-star fa-2x"></label> <label
								class="preview_la">&nbsp;&nbsp; 평점:</label> &nbsp;&nbsp;<font
								color="orange">${score }</font></br> <label class="fa fa-phone fa-2x"></label>
							<label class="preview_la">&nbsp;&nbsp;&nbsp; 연락처:</label>
							&nbsp;&nbsp;<b>${preview.phone }</b></br> <label
								class="fa fa-map-marker fa-2x"></label> <label
								class="preview_la">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 위치:</label>
		...
		<table style="margin-left: 18%; width: 64%;">
			<tr class="comm_tr">
				<td class="comm_td"><input type="button" readonly="readonly"
					value="글제목" id="review_img"> ${review.title }</td>
			</tr>
		</table>
		...
		<div id="like_hate">
			<a href='javascript:gbCheck("good",${review.no },${userNo })'><img
				alt="good" src="/matna/resource/images/good_content.PNG"></a> :
			&nbsp;&nbsp;<span id="good">${review.good }</span> &nbsp;&nbsp;&nbsp;
			<a href='javascript:gbCheck("bad",${review.no },${userNo })'><img
				alt="bad" src="/matna/resource/images/bad_content.PNG"></a> :
			&nbsp;&nbsp;<span id="bad">${review.bad }</span> &nbsp;&nbsp;&nbsp;
			<c:choose>
				<c:when
					test="${(userGrade > 3 || userNo == review.writer ) && isLogin == true}">
					<input id="reviewup" type="button" value="수정"
						onclick="updateReview()">
					<input id="reviewdel" type="button" value="삭제"
		...
		<c:if test="${isCount==true }">
			<div style="position: absolute; margin-left: 66%; margin-top: -5%;">
				<a style="color: gray; font-weight: 400; font-size: 15px; 
					margin-left: 20%; margin-bottom: 10px">남 VS 여 선호도</a>
		...
		<c:if test="${isCount==false }">
			<div style="position: absolute; margin-left: 66%; margin-top: -5%;">
				<a style="color: gray; font-weight: 400; font-size: 15px; 
					margin-left: 20%; margin-bottom: 10px">남 VS 여 선호도</a>
				<div>
					<img alt="" src="/matna/resource/img/chart.jpg"
